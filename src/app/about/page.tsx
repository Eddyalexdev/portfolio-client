...
import {motion, useAnimationFrame, useMotionValue, useTime, useTransform} from 'framer-motion'
    ...
    <>
      <motion.section style={{x: 200}} className="w-full h-screen grid place-items-center relative z-10">
        <div className="grid grid-cols-6 grid-rows-3 relative">
          ...
          >
            <div className="p-4 border border-white max-h-[400px] overflow-hidden">
              <motion.ul 
